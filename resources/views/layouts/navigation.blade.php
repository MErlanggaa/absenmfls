<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('approval-requests.index')" :active="request()->routeIs('approval-requests.*')">
                        {{ __('Pengajuan') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-4">
                <a href="{{ route('notifications.index') }}" class="relative p-2 text-gray-500 hover:text-gray-700 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('approval-requests.index')" :active="request()->routeIs('approval-requests.*')">
                {{ __('Pengajuan') }}
            </x-responsive-nav-link>
